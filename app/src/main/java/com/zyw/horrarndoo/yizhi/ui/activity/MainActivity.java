...
public class MainActivity extends BaseCompatActivity implements HomeFragment
    ...
    NavigationView nvMenu;//菜单
    @BindView(R.id.dl_root)
    DrawerLayout dlRoot;//抽屉
    @BindView(R.id.bviv_bar)
    BottomNavigationView bottomNavigationView;//底部Bottom;
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        civHead.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dlRoot.closeDrawer(GravityCompat.START);//关闭抽屉
                bottomNavigationView.setSelectedItemId(R.id.menu_item_personal);//显示哪个bottom
            }
        });
